...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div
        data-anim="faker-image"
        className="pointer-events-none absolute bottom-0 right-[-10vw] z-20 hidden h-[96vh] w-[64vw] max-w-264 lg:block 2xl:right-[-1vw] 2xl:h-[80vh] 2xl:w-[62vw]"
      >
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_55%_48%,rgba(240,237,126,0.16),transparent_42%)] blur-2xl" />
      ...
      <section className="relative z-10 mx-auto flex min-h-0 flex-1 w-full max-w-7xl items-center px-4 pb-6 pt-5 sm:px-6 sm:pb-8 sm:pt-6 lg:pb-12">
        <div className="relative w-full">
          <div className="relative z-10 w-full max-w-6xl">
            ...
            >
              Organizá partidas de League of Legends entre amigos y generá
              equipos balanceados según elo, peak elo y roles preferidos.
            </p>
            ...
            <p className="mt-5 max-w-sm text-sm leading-6 text-[#8a8a85] sm:mt-7 sm:max-w-none sm:text-base">
              Acceso rápido. Sin fricción. Hecho para organizar mejor cada
              lobby.
            </p>
          </div>
        </div>
